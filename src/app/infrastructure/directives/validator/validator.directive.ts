...
import {Languages} from "../../data/enums/language.enum";
import { LocalStorageService } from "../../services/LocalStorageService.service";
import { LanguageService } from "../../interceptors/service/language.service";
...
export class ValidatorDirective implements OnInit, OnChanges {
  ...
  toggleValidClass(valid: boolean){
    if(valid) {
      ...
      } else if( this.el.nativeElement.parentElement.parentElement.parentElement.parentElement.parentElement.classList.contains("new-custom-select")){
        this.renderer.removeClass(this.el.nativeElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement, "is-invalid");
        this.renderer.addClass(this.el.nativeElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement, "is-valid");
      }
      else {
      ...
      if (this.el.nativeElement.attributes['matinput'] != null && this.el.nativeElement.attributes['ng-reflect-autocomplete'] != null) {
        ...
        this.renderer.removeClass(this.el.nativeElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement, "is-valid");
        this.renderer.addClass(this.el.nativeElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement, "is-invalid");
      }else {
  ...
  @HostListener('openedChange') onMatSelectChange() {
    // console.log('dateInput');
    this.validate();
  }
